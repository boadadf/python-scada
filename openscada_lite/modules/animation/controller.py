...
from openscada_lite.common.models.dtos import StatusDTO, AnimationUpdateMsg

class AnimationController(BaseController[AnimationUpdateMsg, None]):
    def __init__(self, model, socketio, base_event="animation", flask_app=None):
        super().__init__(model, socketio, AnimationUpdateMsg, None, base_event=base_event, flask_app=flask_app)
